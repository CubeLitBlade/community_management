...
\restrict RIM7MrGJtQAgzgqbYlPZQitcOoXCQhHCnFOidD9CxpsF6PUtxNGQgFUIdJ3zM5j
...
--
-- Name: COLUMN event.type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN event.payload; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN event.status; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN event.retry_count; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN event.error_msg; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN event.next_run_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN event.current_step; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.event.current_step IS '当前所在的步骤。';
...
--
-- Name: index_events_status_pending; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: event trigger_update_events_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
\unrestrict RIM7MrGJtQAgzgqbYlPZQitcOoXCQhHCnFOidD9CxpsF6PUtxNGQgFUIdJ3zM5j
