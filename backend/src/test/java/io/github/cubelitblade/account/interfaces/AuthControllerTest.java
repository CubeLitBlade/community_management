...
class AuthControllerTest {
  ...
  class register {
    ...
    void success() {
      ...
      AccountRegisterRequest request = new AccountRegisterRequest("user", "password123");
    ...
    void duplicateUsername() {
      AccountRegisterRequest request = new AccountRegisterRequest("duplicate", "password123");
