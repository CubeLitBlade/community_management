...
public class Account {
  ...
  public static Account register(
      Username username, String submittedPassword, PasswordService hasher, Instant now) {
  ...
  public void changePassword(
      String currentPassword, String newPassword, PasswordService passwordService, Instant now) {
